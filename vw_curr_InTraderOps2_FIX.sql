...
CREATE view [dbo].[vw_curr_InTraderOps2_FIX] as
/***********************************************************
View Description:Will show the most current days records for the InTradersOps2 report.
...
/*=============================================================================
  ...
  spInsertValsToAdjValTemp_FIX. Deploy the two together.
...
and hold.IsSettled = 'Y'           --Added filter flag to exclude Intraday records
),
