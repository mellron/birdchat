...
1. **Message formats** — Based on our review of GSD200, we believe we need to use the **MT515 DVP style** for Delivery vs. Payment (DVP) repo transactions and the **MT515 GCF style** for General Collateral Finance (GCF) repo transactions. Can you confirm this is correct for our use case?
...
Please let me know if you need any additional information about our setup or transaction types.
