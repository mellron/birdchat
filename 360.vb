...
#End Region
    ...
    Protected Function CalculateGeneric360_V2(ByVal curveName As String,
        ...
        Try
            ...
            For month As Integer = 1 To term
                ...
                ' --- Original logic using cumulative funding cost ---
                ...
                ' --- Updated logic to align with Excel: funding cost is charged on beginning balance ---
                cofPmt(month) = outPrin(month - 1) * cofRates(month) / 12 + prinPmt(month)
            Next
    ...
    Protected Function CalculateFHLBCredit360(ByVal term As Integer, ByVal amort As Integer, ByVal accBasis As AccrualBasis,
        ...
        Return CalculateGeneric360_V2("FHLBCredit360", term, amort, accBasis, amortType, prinFreq, intFreq, residual, interestOnly, mosToFirstPrinPmt, mosToFirstIntPmt)
    End Function
    ...
    Protected Function CalculateCIP360(ByVal term As Integer, ByVal amort As Integer, ByVal accBasis As AccrualBasis,
                                       ...
                                       ByVal intFreq As PaymentFrequency, ByVal residual As Double, ByVal interestOnly As Integer,
                                       Optional ByVal mosToFirstPrinPmt As Integer = 0, Optional ByVal mosToFirstIntPmt As Integer = 0) As Double
        Return CalculateGeneric360_V2("CIP360", term, amort, accBasis, amortType, prinFreq, intFreq, residual, interestOnly, mosToFirstPrinPmt, mosToFirstIntPmt)
    End Function
