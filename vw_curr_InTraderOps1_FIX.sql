CREATE view [dbo].[vw_curr_InTraderOps1_FIX] as
/***********************************************************
View Description: Most-current-day records for the InTraderOps1 report (IPOPS 1 & 2 source).
...
/*=============================================================================
  ...
  DEPLOY    ALTER the REAL dbo.vw_curr_InTraderOps1 with this body. This _FIX object
            exists for side-by-side testing only.

  GRAIN     Output is one row per lot (AsOfDate/Group/Intent/Security/Ticket).
            NOTE: the base "curr" view filters to JobId = MAX(JobId), preserved below.
=============================================================================*/
SELECT
      Detail.AsOfDate
    , Detail.Group_IT
